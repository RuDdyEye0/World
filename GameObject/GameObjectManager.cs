...
public class GameObjectManager : MonoSingleton<GameObjectManager> 
{
	...
	protected override void OnStart () {
		...
		CharacterManger.Instance.OnCharacterEnter += OnCharacterEnter;
		CharacterManger.Instance.OnCharacterLeave += OnCharacterLeave;
    ...
    {
		foreach (var cha in CharacterManger.Instance.Characters.Values)
        {
			CreateCharacterObject(cha);
			yield return null;
        }
